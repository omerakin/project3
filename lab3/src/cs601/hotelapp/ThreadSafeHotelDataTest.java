 ...
 *
 */
public class ThreadSafeHotelDataTest {
	...
	public void testGetHotels() {
		...
		ThreadSafeHotelData hdata = new ThreadSafeHotelData();
		HotelDataBuilder hotelDataBuilder = new HotelDataBuilder(hdata);
	...
	public void testPrintToFile() {
		...
		hotelDataBuilder.loadHotelInfo(inputHotelFile);
		hotelDataBuilder.loadReviews(Paths.get(TestUtils.INPUT_DIR + File.separator + "reviews8000"));
		Path actual = Paths.get(TestUtils.OUTPUT_DIR + File.separator + "studentOutput"); // your
																							// result
																							// is
																							// in
		System.out.println("Before printToFile");																					// studentOutputFile
		hotelDataBuilder.printToFile(actual);
		System.out.println("After printToFile");
